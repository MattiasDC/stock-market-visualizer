...
def register_callbacks(app, server):
    ...
    def remove_ticker(previous, current, engine_id):
        ...
        return get_traces_and_layout(engine_id, client), engine_id
...
## Refactor indicator callbacks/layout ticker callbacks, graph callbacks
## Remove indicators of removed ticker
## create indicator on graph