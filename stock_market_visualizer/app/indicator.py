...
class IndicatorLayout:
    ...
    def register_callbacks(self, app, client_getter):
        ...
        def add_create_indicator_callbacks(indicator, arguments):
            @app.callback(Input(*self.checkable_table.dropdown_button.get_item_n_clicks(indicator.__name__)),
            ...
            @app.callback(Input(*self.modal_creator.get_add_n_clicks(indicator)),
                          State(*self.checkable_table.get_table()),
                          ...
                          [State(*self.modal_creator.get_argument_value(indicator, argument)) for argument in arguments],
                          Output(*self.modal_creator.get_is_open(indicator)),
                          Output(*self.checkable_table.get_table()),
