...
from stock_market_visualizer.app.signals.common import CustomNameLayout,\
                                                       SentimentDropdownLayout,\
                                                       SignalDetectorConfigurationLayout
from stock_market_visualizer.app.signals.ticker_signal_detector import TickerDropdownLayout, TickerDetectorHandler
