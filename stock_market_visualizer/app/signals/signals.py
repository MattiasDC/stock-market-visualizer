...
from stock_market_visualizer.app.signals.common import get_api_supported_signal_detectors,\
...
from stock_market_visualizer.app.signals.crossover_signal_detector import CrossoverDetectorConfigurationLayout
from stock_market_visualizer.app.signals.ticker_signal_detector import TickerDetectorConfigurationLayout
from stock_market_visualizer.app.signals.trivial_signal_detector import TrivialSignalDetectorConfigurationLayout
...
class SignalDetectorLayout:
    def __init__(self, engine_layout):
        ...
        self.ticker_based_config_layouts = [
             TickerDetectorConfigurationLayout(sd, engine_layout, self.signal_detector_data_layout)
